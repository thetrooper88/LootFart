...
public static class RenderUtils.Buffer {
    ...
    public RenderUtils.Buffer(class_293.class_5596 drawMode, class_293 vertexFormat) {
    ...
    public RenderUtils.Buffer vertex(double x, double y, double z) {
        if (this.buffer == null) {
            return this;
        }
    ...
    public RenderUtils.Buffer vertexTex(double x, double y, double z, float u, float v) {
        if (this.buffer == null) {
            return this;
        }
        Vector4d vector4d = this.positionMatrix.transform(new Vector4d(x, y, z, 1.0));
    ...
    public RenderUtils.Buffer vertexLine(double x1, double y1, double z1, double x2, double y2, double z2) {
        if (this.buffer == null) {
            return this;
        }
        float k = (float)(x2 - x1);
